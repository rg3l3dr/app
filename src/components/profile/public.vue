        ...
        <form class='form' id='profileForm' enctype="multipart/form-data">
          <div class="form-group has-feedback"
            :class="{
              ...
              'has-error': errors.profile.public_name.isValid == false || errors.profile.public_name.hasError
              }">
          ...
          <div class="form-group has-feedback"
            :class="{
              ...
              'has-error': errors.profile.public_email.isValid == false || errors.profile.public_email.hasError
              }">
          ...
          <div class="form-group has-feedback"
            :class="{
              ...
              'has-error': errors.profile.website.isValid == false || errors.profile.website.hasError
              }">
          ...
          <div class="form-group has-feedback"
            :class="{
              ...
              'has-error': errors.profile.location.isValid == false || errors.profile.location.hasError
              }">
          ...
          <div class="form-group has-feedback"
            :class="{
              ...
              'has-error': errors.profile.picture.isValid == false || errors.profile.picture.hasError
              }">
          ...
          <div class="form-group has-feedback"
            :class="{
              ...
              'has-error': errors.profile.about.isValid == false || errors.profile.about.hasError
              }">
          ...
          <button class='btn btn-primary' id='update_profile_btn' @click.prevent='updateProfile'>
        Update Profile
          </button>
        </form>
